...
const limit = rl?.group?.song?.hour;     // may actions per timeframe
const tf = ms?.hour;                     // timeframe in milliseconds
...
export const groupSongHour: GroupSongHour = new GroupSongHour();