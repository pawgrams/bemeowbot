...
export class DrillMenu {
    ...
    public async handle(): Promise<void> {
        ...
        try {
            ...
            const drillMenu: {inline_keyboard: InlineKeyboardButton[][]}  = {

                inline_keyboard: [
                    [
                        { text: "/drill", callback_data: "/drill " },
                        { text: "ℹ️", callback_data: "drill_alert" },
                    ],
                    [
                        { text: "/futuredrill", callback_data: "/futuredrill " },
                        { text: "ℹ️", callback_data: "futuredrill_alert" },
                    ],
                    [
                        { text: "/harddrill", callback_data: "/harddrill " },
                        { text: "ℹ️", callback_data: "harddrill_alert" },
                    ],
                    [
                        { text: "/arabdrill", callback_data: "/arabdrill " },
                        { text: "ℹ️", callback_data: "arabdrill_alert" },
                    ],
                    [
                        { text: "/latindrill", callback_data: "/latindrill " },
                        { text: "ℹ️", callback_data: "latindrill_alert" },
                    ],
                    [
                        { text: "/gangdrill", callback_data: "/gangdrill " },
                        { text: "ℹ️", callback_data: "gangdrill_alert" },
                    ],
                    [
                        { text: "/afrodrill", callback_data: "/afrodrill " },
                        { text: "ℹ️", callback_data: "afrodrill_alert" },
                    ],
                    [
                        { text: "/edmdrill", callback_data: "/edmdrill " },
                        { text: "ℹ️", callback_data: "edmdrill_alert" },
                    ],
                    [
                        { text: "/popdrill", callback_data: "/popdrill " },
                        { text: "ℹ️", callback_data: "popdrill_alert" },
                    ],
                    [
                        { text: "/liquidrill", callback_data: "/liquidrill " },
                        { text: "ℹ️", callback_data: "liquidrill_alert" },
                    ],
                    [
                        { text: "/orchdrill", callback_data: "/orchdrill " },
                        { text: "ℹ️", callback_data: "orchdrill_alert" },
                    ],
                    [
                        { text: "/metaldrill", callback_data: "/metaldrill " },
                        { text: "ℹ️", callback_data: "metaldrill_alert" },
                    ],
            ...
            if(messageId){ // callback excluded given through checking if message id exists
                if(
                    ...
                    throw Error(`🛡 rate limited => drillMenu => user ${userId}`);
                }
            }
            ...
            if(messageIdCallback){ 
                this.ctx.telegram.editMessageCaption(
                    ...
                    undefined,
                    reply,
                    { parse_mode: 'HTML', reply_markup: drillMenu }
                );
            } else {
            ...
            console.log("❌ menu => genres => drill.js", e instanceof Error ? e.message : e);
        }
